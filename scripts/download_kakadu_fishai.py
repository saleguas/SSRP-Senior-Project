#!/usr/bin/env python3
"""
Download the Kakadu FishAI training dataset from Zenodo.

By default this downloads the training zip into
data/raw/kakadu-fishai/. Downloads are resumable when the server
...
DATASET_PAGE_URL = "https://zenodo.org/records/7250921"
TRAINING_ZIP_URL = (
    "https://zenodo.org/records/7250921/files/"
    "202210-KakaduFishAI-TrainingData.zip?download=1"
)
TRAINING_ZIP_NAME = "202210-KakaduFishAI-TrainingData.zip"
DEFAULT_OUTPUT = "data/raw/kakadu-fishai"
...
def main() -> int:
    ...
    download_file(TRAINING_ZIP_URL, out_dir / TRAINING_ZIP_NAME, force=args.force)
    return 0
