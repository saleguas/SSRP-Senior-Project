#!/usr/bin/env python3
"""
Download the MIT Sea Grant River Herring dataset from LILA.

By default this downloads the image zip and the metadata zip into
data/raw/mit-sea-grant-river-herring/. Downloads are resumable when the
...
DEFAULT_OUTPUT = "data/raw/mit-sea-grant-river-herring"
...
def main() -> int:
    ...
    targets = [(METADATA_ZIP_URL, "mit_sea_grant_river_herring.json.zip")]
    if not args.metadata_only:
        targets.insert(0, (IMAGE_ZIP_URL, "mit_river_herring.zip"))
